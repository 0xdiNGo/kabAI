...
A self-hosted agent orchestration platform for building agents that think together. Configure agents with distinct expertise and personalities, ground them in knowledge bases with hybrid vector+keyword retrieval, and run structured kabAInet discussions where multiple agents debate, critique, and synthesize until they reach consensus. Solo chat when you need a quick answer. kabAInet when you need the right one.
...
- Multi-agent kabAInet discussions with configurable rounds and consensus detection
...
│   │   │   ├── orchestration/ # kabAInet multi-agent collaboration
